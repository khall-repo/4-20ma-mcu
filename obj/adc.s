...
__zero_reg__ = 1
	...
	.stabs	"src/adc.c",100,0,2,.Ltext0
	.text
.Ltext0:
	...
	.stabn	162,0,0,0
	.stabn	162,0,0,0
	.stabs	"init_adc:F(0,49)",36,0,4,init_adc
.global	init_adc
...
.Lscope1:
	...
	.stabd	78,0,0
	.stabs	"read_adc:F(5,4)",36,0,19,read_adc
.global	read_adc
	.type	read_adc, @function
read_adc:
	.stabd	46,0,0
	.stabn	68,0,20,.LM5-.LFBB2
.LM5:
.LFBB2:
/* prologue: function */
/* frame size = 0 */
...
.LM7:
	sbic 0x6,6
	rjmp .L3
	.stabn	68,0,28,.LM8-.LFBB2
.LM8:
	in r24,0x4
	in r25,0x4+1
	.stabn	68,0,29,.LM9-.LFBB2
.LM9:
	ret
